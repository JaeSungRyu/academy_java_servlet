...
<body>
	...
	pageContext.setAttribute("name", "길동이-page");
	...
	application.setAttribute("name", "길동이-app");
	...
	3.session : \${sessionScope.id} = ${sessionScope.id}  
	4.application : \${applicationScope.id} = ${applicationScope.id}  
	
	5.범위를 명시하지 않고 속성 값만 명시할때 어떤 범위가 선택되는가
	=>가장 작은 범위의 것이 자동 선택됨
	\${id} =  ${id}
	...
	<hr>
	<h3>scriptlet,expression tag를 사용하여 추출</h3>
	<%
